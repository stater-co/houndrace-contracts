...
export declare namespace AlphaERC721 {
  export type ConstructorStruct = { name: string; symbol: string };
...
export interface AlphaERC721 extends BaseContract {
  contractName: "AlphaERC721";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AlphaERC721Interface;
