...
async function basicTest(
  ...
  describe('Genetics Basic Tests', async function () {
    ...
    it("Genetics - wholeArithmeticRecombination", async function () {
        ...
        expecting(globalParams.maleBoilerplateGene !== newGeneticSequence && globalParams.femaleBoilerplateGene !== newGeneticSequence, "Failed to generate a valid genetic sequence via whole arithmetic recombination");
    });
